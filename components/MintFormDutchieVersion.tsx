...
export default function Form() {
  ...
  return (
    <div
      className="isolate space-y-4 sm:space-y-2 rounded-2xl shadow-lg bg-brand-800 bg-opacity-50 p-4 w-full md:w-full lg:w-full mx-auto"
      style={{
        position: 'relative',
...
// <div className="relative rounded-xl px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-brand-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-brand-600 flex justify-between items-center">
// {/* Account Information */}
// <div>
//   <label htmlFor="account" className="block text-sm font-medium text-brand-100">
//     Account
//   </label>
//   <div
//     id="account"
//     className="block w-full border-0 bg-transparent text-brand-100 placeholder:text-brand-400 sm:text-base"
//   >
...
//   <label htmlFor="mintedTokens" className="block text-sm font-medium text-brand-100">
//     Minted Tokens
//   </label>
//   <div
//     id="mintedTokens"
//     className="block w-full border-0 bg-transparent text-center text-brand-100 placeholder:text-brand-400 sm:text-base"
//   >
//     {currentSupply} / 1000
//   </div>
// </div>
...
// {/* Batches Indicator */}
// <div>
//   <label htmlFor="batches" className="block text-sm font-medium text-brand-100 text-right">
//     Batches
//   </label>
...
//     className="flex-shrink-0 flex flex-col items-center justify-center bg-brand-900 rounded-xl p-2 shadow-lg transition-transform transform hover:scale-105 w-40 sm:w-48 md:w-56 lg:w-64"
//   >
...
//     />
//     <div
//       className="text-brand-100 mt-2 text-center truncate w-full"
//       title={nft.token.name}
//     >
//       {nft.token.name}
//     </div>
//     <div className="flex justify-between w-full px-2 mt-1">
//       <span className="text-brand-100 text-sm flex items-center">
//         <span className="h-2 w-2 bg-green-500 rounded-full mr-1"></span>Live
//       </span>
//       <span className="text-brand-100 text-sm">ID: {nft.token.tokenId}</span>
//     </div>
//   </a>
// ))}
// </div>
...
//       target="_blank"
//       rel="noopener noreferrer"
//       className="hover:bg-brand-800 text-white py-2 px-6 rounded-full hover:bg-opacity-60 ring-1 ring-inset ring-brand-300 hover:ring-brand-100 flex items-center space-x-2 transition-colors duration-200 justify-center min-w-0"
//     >
//       <img src="/dbw.png" alt="DigiBazaar Logo" className="h-6" />
//       <span
//         className="text-brand-100 truncate flex-0"
...
//       target="_blank"
//       rel="noopener noreferrer"
//       className="hover:bg-brand-800 text-white py-2 px-6 rounded-full hover:bg-opacity-60 ring-1 ring-inset ring-brand-300 hover:ring-brand-100 flex items-center space-x-2 transition-colors duration-200 justify-center"
//     >
//       <img src="/etherscan.svg" alt="Etherscan Logo" className="h-6" />
//       <span className="text-brand-100">View on Etherscan</span>
//     </a>
//   </div>
// </div>
// )}
...
// {/* Batch Selection */}
// <div className="relative rounded-xl px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-brand-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-brand-600">
//   <label htmlFor="batch" className="block text-center text-sm font-medium text-brand-100">
//       Batch
//   </label>
...
//       name="batch"
//       id="batch"
//       className="block w-full border-0 bg-brand-800 bg-opacity-60 text-brand-100 placeholder:text-brand-400 focus:ring-0 sm:text-base rounded-lg appearance-none pr-8"
...
//   </div>
//   {isLoadingBatches && (
//     <div className="text-brand-100 text-sm mt-2">Loading batches...</div>
//   )}
// </div>

// {/* Number of Tokens */}
// <div className="relative rounded-xl px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-brand-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-brand-600">
//   <label htmlFor="tokens" className="block text-center text-sm font-medium text-brand-100">
//       Number of Tokens
//   </label>
...
//           name="tokens"
//           id="tokens"
//           className="block w-full border-0 bg-brand-800 bg-opacity-60 text-brand-100 placeholder:text-brand-400 focus:ring-0 sm:text-base rounded-lg text-center"
//           placeholder="1"
//           value={tokens}
//           onChange={e => {
...
//   <div className="flex-grow relative rounded-xl px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-brand-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-brand-600 w-1/2 mr-2">
//     <label htmlFor="referral" className="block text-center text-sm font-medium text-brand-100">
//       Referral Code
//     </label>
//     <input
//       id="referral"
//       className="block w-full h-auto border-0 bg-brand-800 bg-opacity-60 text-brand-100 placeholder:text-brand-400 focus:ring-0 sm:text-base rounded-lg"
//       placeholder="Enter Code"
//       value={referralCode}
//       onChange={e => setReferralCode(e.target.value)}
//     />
//   </div>
//   <div className="flex-grow relative rounded-xl px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-brand-300 w-1/2 ml-2">
//       <label htmlFor="price" className="block text-center text-sm font-medium text-brand-100">
//           Price
//       </label>
//       <input
//           id="price"
//           className="block w-full h-auto text-brand-100 sm:text-base rounded-lg font-bold bg-brand-800 bg-opacity-60 p-2 pr-2 text-right"
//           type="text"
//           readOnly
//           value={
//             isLoadingPrice
...
// {/* Whitelist Checkbox */}
// <div className="relative rounded-lg flex items-center px-3 pb-1.5 pt-1.5 ring-1 ring-inset ring-brand-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-brand-600">
//   <input
//       type="checkbox"
//       name="whitelist"
//       id="whitelist"
...
//   />
//   <label htmlFor="whitelist" className="ml-3 block text-sm font-medium text-brand-100">
//       Whitelist
//   </label>
// </div>
