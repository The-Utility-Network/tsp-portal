...
const colors = {
  ...
  brand: [
    '[--switch-bg-ring:theme(colors.brand.600/90%)] [--switch-bg:theme(colors.brand.500)] dark:[--switch-bg-ring:transparent]',
    '[--switch:white] [--switch-ring:theme(colors.brand.600/90%)] [--switch-shadow:theme(colors.brand.900/20%)]',
  ],
  teal: [
